...
1️⃣ create_table — Создание таблицы
Синтаксис:
...
3️⃣ drop_table — Удаление таблицы
Синтаксис:
...
Демонстрация
<!-- После записи asciinema добавьте сюда ссылку --> <!-- [![asciicast](https://asciinema.org/a/XXXXX.svg)](https://asciinema.org/a/XXXXX) -->
Автор
